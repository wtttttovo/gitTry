...
test('rejects', async t => {
	...
	t.falsy(_rec._expr(_rec._capt(promise, 'arguments/0'), {
		content: 't.falsy(promise)',
		filepath: 'promise.test.js',
		line: 6,
		async: true,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"promise","range":[8,15]}],"range":[0,16]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"promise","range":[8,15]},{"type":{"label":")"},"range":[15,16]}]',
...
test('promise&async', async t => {
	...
	t.plan(2);
	t.falsy(_rec2._expr(_rec2._capt((await _rec2._capt(_rec2._capt(Promise, 'arguments/0/argument/callee/object/callee/object').reject('fail'), 'arguments/0/argument/callee/object').catch(err => {
		console.log(err);
	})), 'arguments/0'), {
	...
	t.truthy(_rec3._expr(_rec3._capt((await _rec3._capt(_rec3._capt(Promise, 'arguments/0/argument/callee/object/callee/object').resolve('success'), 'arguments/0/argument/callee/object').then(data => {
		console.log(data);
	})), 'arguments/0'), {
...
test('promise-catch-truthy', async t => {
	...
	t.plan(3);
	return t.truthy(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(Promise, 'arguments/0/callee/object/callee/object').reject(1), 'arguments/0/callee/object').catch(err => {
		t.is(err, 1);
		t.is(err, 1);
	}), 'arguments/0'), {
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/534002765ab876114e5f47b28a8b5a18.js.map