...
test('promise&async', async t => {
	...
	t.plan(2);
	t.falsy(_rec._expr(_rec._capt((await _rec._capt(Promise, 'arguments/0/argument/callee/object').reject('fail')), 'arguments/0'), {
		content: 't.falsy((await Promise.reject(\'fail\')))',
		filepath: 'promise.test.js',
		line: 16,
		async: true,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"AwaitExpression","argument":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Promise","range":[15,22]},"property":{"type":"Identifier","name":"reject","range":[23,29]},"computed":false,"range":[15,29]},"arguments":[{"type":"StringLiteral","value":"fail","range":[30,36]}],"range":[15,37]},"range":[9,37]}],"range":[0,39]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"await","range":[9,14]},{"type":{"label":"name"},"value":"Promise","range":[15,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"reject","range":[23,29]},{"type":{"label":"("},"range":[29,30]},{"type":{"label":"string"},"value":"fail","range":[30,36]},{"type":{"label":")"},"range":[36,37]},{"type":{"label":")"},"range":[37,38]},{"type":{"label":")"},"range":[38,39]}]',
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/d8accf7f88d8e1c312ab818a697e4a23.js.map