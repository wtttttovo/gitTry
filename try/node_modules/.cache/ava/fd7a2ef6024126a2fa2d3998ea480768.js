...
test(t => {
    ...
    const b = 'bar';
    const c = 'baz';
    t.true(_rec._expr(_rec._capt(_rec._capt(_rec._capt(a, 'arguments/0/left/callee/object').test(_rec._capt(b, 'arguments/0/left/arguments/0')), 'arguments/0/left') || _rec._capt(_rec._capt(b, 'arguments/0/right/left') === _rec._capt(c, 'arguments/0/right/right'), 'arguments/0/right'), 'arguments/0'), {
        content: 't.true(a.test(b) || b === c)',
        filepath: 'ava.js',
        line: 22,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"LogicalExpression","operator":"||","left":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"a","range":[7,8]},"property":{"type":"Identifier","name":"test","range":[9,13]},"computed":false,"range":[7,13]},"arguments":[{"type":"Identifier","name":"b","range":[14,15]}],"range":[7,16]},"right":{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"b","range":[20,21]},"right":{"type":"Identifier","name":"c","range":[26,27]},"range":[20,27]},"range":[7,27]}],"range":[0,28]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"a","range":[7,8]},{"type":{"label":"."},"range":[8,9]},{"type":{"label":"name"},"value":"test","range":[9,13]},{"type":{"label":"("},"range":[13,14]},{"type":{"label":"name"},"value":"b","range":[14,15]},{"type":{"label":")"},"range":[15,16]},{"type":{"label":"||"},"value":"||","range":[17,19]},{"type":{"label":"name"},"value":"b","range":[20,21]},{"type":{"label":"==/!="},"value":"===","range":[22,25]},{"type":{"label":"name"},"value":"c","range":[26,27]},{"type":{"label":")"},"range":[27,28]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/fd7a2ef6024126a2fa2d3998ea480768.js.map