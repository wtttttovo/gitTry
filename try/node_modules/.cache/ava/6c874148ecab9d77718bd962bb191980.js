...
test('promise&async', async t => {
	...
	return t.truthy(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(Promise, 'arguments/0/callee/object/callee/object').resolve('success'), 'arguments/0/callee/object').then(data => {
		console.log(data);
	}), 'arguments/0'), {
		content: 't.truthy(Promise.resolve(\'success\').then(data => { console.log(data); }))',
		filepath: 'ava.js',
		line: 17,
		async: true,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Promise","range":[9,16]},"property":{"type":"Identifier","name":"resolve","range":[17,24]},"computed":false,"range":[9,24]},"arguments":[{"type":"StringLiteral","value":"success","range":[25,34]}],"range":[9,35]},"property":{"type":"Identifier","name":"then","range":[36,40]},"computed":false,"range":[9,40]},"arguments":[{"type":"ArrowFunctionExpression","params":[{"type":"Identifier","name":"data","range":[41,45]}],"body":{"type":"BlockStatement","body":[{"type":"ExpressionStatement","expression":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"console","range":[51,58]},"property":{"type":"Identifier","name":"log","range":[59,62]},"computed":false,"range":[51,62]},"arguments":[{"type":"Identifier","name":"data","range":[63,67]}],"range":[51,68]},"range":[51,69]}],"directives":[],"range":[49,71]},"async":false,"range":[41,71]}],"range":[9,72]}],"range":[0,73]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"Promise","range":[9,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"resolve","range":[17,24]},{"type":{"label":"("},"range":[24,25]},{"type":{"label":"string"},"value":"success","range":[25,34]},{"type":{"label":")"},"range":[34,35]},{"type":{"label":"."},"range":[35,36]},{"type":{"label":"name"},"value":"then","range":[36,40]},{"type":{"label":"("},"range":[40,41]},{"type":{"label":"name"},"value":"data","range":[41,45]},{"type":{"label":"=>"},"range":[46,48]},{"type":{"label":"{"},"range":[49,50]},{"type":{"label":"name"},"value":"console","range":[51,58]},{"type":{"label":"."},"range":[58,59]},{"type":{"label":"name"},"value":"log","range":[59,62]},{"type":{"label":"("},"range":[62,63]},{"type":{"label":"name"},"value":"data","range":[63,67]},{"type":{"label":")"},"range":[67,68]},{"type":{"label":";"},"range":[68,69]},{"type":{"label":"}"},"range":[70,71]},{"type":{"label":")"},"range":[71,72]},{"type":{"label":")"},"range":[72,73]}]',
		visitorKeys: _powerAssertVisitorKeys
	}));
});
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/6c874148ecab9d77718bd962bb191980.js.map