...
test('promise&async', async t => {
	...
	t.plan(1);
	t.falsy(_rec._expr(_rec._capt((await _rec._capt(_rec._capt(Promise, 'arguments/0/argument/callee/object/callee/object').reject('fail'), 'arguments/0/argument/callee/object').catch(data => {
		console.log(data);
	})), 'arguments/0'), {
		content: 't.falsy((await Promise.reject(\'fail\').catch(data => { console.log(data); })))',
		filepath: 'promise.test.js',
		line: 16,
		async: true,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"AwaitExpression","argument":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Promise","range":[15,22]},"property":{"type":"Identifier","name":"reject","range":[23,29]},"computed":false,"range":[15,29]},"arguments":[{"type":"StringLiteral","value":"fail","range":[30,36]}],"range":[15,37]},"property":{"type":"Identifier","name":"catch","range":[38,43]},"computed":false,"range":[15,43]},"arguments":[{"type":"ArrowFunctionExpression","params":[{"type":"Identifier","name":"data","range":[44,48]}],"body":{"type":"BlockStatement","body":[{"type":"ExpressionStatement","expression":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"console","range":[54,61]},"property":{"type":"Identifier","name":"log","range":[62,65]},"computed":false,"range":[54,65]},"arguments":[{"type":"Identifier","name":"data","range":[66,70]}],"range":[54,71]},"range":[54,72]}],"directives":[],"range":[52,74]},"async":false,"range":[44,74]}],"range":[15,75]},"range":[9,75]}],"range":[0,77]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"await","range":[9,14]},{"type":{"label":"name"},"value":"Promise","range":[15,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"reject","range":[23,29]},{"type":{"label":"("},"range":[29,30]},{"type":{"label":"string"},"value":"fail","range":[30,36]},{"type":{"label":")"},"range":[36,37]},{"type":{"label":"."},"range":[37,38]},{"type":{"label":"catch"},"value":"catch","range":[38,43]},{"type":{"label":"("},"range":[43,44]},{"type":{"label":"name"},"value":"data","range":[44,48]},{"type":{"label":"=>"},"range":[49,51]},{"type":{"label":"{"},"range":[52,53]},{"type":{"label":"name"},"value":"console","range":[54,61]},{"type":{"label":"."},"range":[61,62]},{"type":{"label":"name"},"value":"log","range":[62,65]},{"type":{"label":"("},"range":[65,66]},{"type":{"label":"name"},"value":"data","range":[66,70]},{"type":{"label":")"},"range":[70,71]},{"type":{"label":";"},"range":[71,72]},{"type":{"label":"}"},"range":[73,74]},{"type":{"label":")"},"range":[74,75]},{"type":{"label":")"},"range":[75,76]},{"type":{"label":")"},"range":[76,77]}]',
...
test('promise-catch truthy', async t => {
	...
	t.plan(3);
	return t.truthy(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(Promise, 'arguments/0/callee/object/callee/object').reject(1), 'arguments/0/callee/object').catch(err => {
		t.is(err, 1);
		t.is(err, 1);
	}), 'arguments/0'), {
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/93c5f38716a513491e3bc9582c26635e.js.map