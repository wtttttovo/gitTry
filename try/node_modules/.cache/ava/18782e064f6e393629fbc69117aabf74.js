...
test('promise&async', async t => {
	...
	t.plan(1);
	let a = await Promise.resolve('success').then(data => {
		console.log(data);
	});
	t.truthy(_rec2._expr(_rec2._capt(a, 'arguments/0'), {
		content: 't.truthy(a)',
		filepath: 'promise.test.js',
		line: 18,
		async: true,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"Identifier","name":"a","range":[9,10]}],"range":[0,11]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"a","range":[9,10]},{"type":{"label":")"},"range":[10,11]}]',
		visitorKeys: _powerAssertVisitorKeys
	}));
});
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/18782e064f6e393629fbc69117aabf74.js.map