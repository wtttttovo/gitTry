...
test('promise&async', async t => {
	...
	t.plan(2);
	t.falsy(_rec._expr(_rec._capt((await _rec._capt(_rec._capt(Promise, 'arguments/0/argument/callee/object/callee/object').reject(1), 'arguments/0/argument/callee/object').catch(() => {})), 'arguments/0'), {
		content: 't.falsy((await Promise.reject(1).catch(() => {})))',
		filepath: 'ava.js',
		line: 17,
		async: true,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"AwaitExpression","argument":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Promise","range":[15,22]},"property":{"type":"Identifier","name":"reject","range":[23,29]},"computed":false,"range":[15,29]},"arguments":[{"type":"NumericLiteral","value":1,"range":[30,31]}],"range":[15,32]},"property":{"type":"Identifier","name":"catch","range":[33,38]},"computed":false,"range":[15,38]},"arguments":[{"type":"ArrowFunctionExpression","params":[],"body":{"type":"BlockStatement","body":[],"directives":[],"range":[45,47]},"async":false,"range":[39,47]}],"range":[15,48]},"range":[9,48]}],"range":[0,50]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"await","range":[9,14]},{"type":{"label":"name"},"value":"Promise","range":[15,22]},{"type":{"label":"."},"range":[22,23]},{"type":{"label":"name"},"value":"reject","range":[23,29]},{"type":{"label":"("},"range":[29,30]},{"type":{"label":"num"},"value":1,"range":[30,31]},{"type":{"label":")"},"range":[31,32]},{"type":{"label":"."},"range":[32,33]},{"type":{"label":"catch"},"value":"catch","range":[33,38]},{"type":{"label":"("},"range":[38,39]},{"type":{"label":"("},"range":[39,40]},{"type":{"label":")"},"range":[40,41]},{"type":{"label":"=>"},"range":[42,44]},{"type":{"label":"{"},"range":[45,46]},{"type":{"label":"}"},"range":[46,47]},{"type":{"label":")"},"range":[47,48]},{"type":{"label":")"},"range":[48,49]},{"type":{"label":")"},"range":[49,50]}]',
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/151379458214c98f25f6b79d0b2e52dc.js.map