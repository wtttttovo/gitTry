...
test('promise&async', async t => {
	...
	t.plan(1);
	t.truthy(_rec._expr(_rec._capt((await _rec._capt(_rec._capt(Promise, 'arguments/0/argument/callee/object/callee/object').resolve('success'), 'arguments/0/argument/callee/object').then(data => {
		console.log(data);
	})), 'arguments/0'), {
...
//# sourceMappingURL=/Users/wangtingting/try/node_modules/.cache/ava/ba46a4a9e39441268f4dbe5cede61297.js.map